...
tiroPostLaguna :: Int -> PostObstaculo
tiroPostLaguna largo tiro
  | superaLaguna largo tiro = tiro {altura = altura tiro `div` largo}
  | otherwise = tiroDetenido

superaLaguna :: Int -> PasaObstaculo
...
cuantosObstaculoConsecutivosSupera :: [Obstaculo] -> Tiro -> Int
